# Foundry Semantic Compiler Phase 0B

Phase 0A established Foundry as a semantic compiler with a canonical graph. Phase 0B extends that architecture so extensions, packs, migrations, and codemods remain graph-native and deterministic.
...
Phase 0B metadata is surfaced through existing build and inspect channels, including extension descriptors, packs, spec formats, codemods, and compatibility summaries.
