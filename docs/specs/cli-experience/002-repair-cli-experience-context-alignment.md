...
- Repair context alignment for:
  - `docs/features/cli-experience.spec.md`
  - `docs/features/cli-experience.md`
  - `docs/features/cli-experience.decisions.md`
...
## Canonical Context
- Canonical feature spec: `docs/features/cli-experience.spec.md`
- Canonical feature state: `docs/features/cli-experience.md`
- Canonical decision ledger: `docs/features/cli-experience.decisions.md`
