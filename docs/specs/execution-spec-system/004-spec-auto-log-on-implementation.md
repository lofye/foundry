...
- Keep implementation logging deterministic, safe, and aligned with the required log format in `docs/specs/README.md`.
...
Append entries using the required format defined in `docs/specs/README.md`.
...
## Authority Rule
- Implementation-log format must match `docs/specs/README.md` exactly.
