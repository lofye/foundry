...
```text
docs/specs/execution-spec-system/drafts/005-implementation-plan-files.md
```
...
- live at `docs/<feature>/plans/<id>-<slug>.md`
...
```json
{
  "status": "created",
  "feature": "<feature>",
  "spec": "docs/<feature>/specs/<id>-<slug>.md",
  "plan": "docs/<feature>/plans/<id>-<slug>.md"
}
```
...
- plan is outside `docs/<feature>/plans/`
...
1. `spec:plan <feature> <id>` creates `docs/<feature>/plans/<id>-<slug>.md`.
...
- Plans are stored at `docs/<feature>/plans/<id>-<slug>.md`.
