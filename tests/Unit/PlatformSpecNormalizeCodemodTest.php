...
final class PlatformSpecNormalizeCodemodTest extends TestCase
{
...
YAML);
    ...
    {
        $codemod = new PlatformSpecNormalizeCodemod();
        $result = $codemod->run(Paths::fromCwd($this->project->root), false);

        $this->assertSame('platform-spec-v1-normalize', $result->codemod);
        ...
        $this->assertContains('FDY2485_PLATFORM_SPEC_PARSE_ERROR', array_values(array_map(
