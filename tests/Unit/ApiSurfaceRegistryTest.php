...
final class ApiSurfaceRegistryTest extends TestCase
{
    ...
    public function test_classifies_cli_commands_by_stability(): void
    {
        ...
        $this->assertSame('experimental', $licensedExplain['stability']);
        $this->assertSame('licensed', $licensedExplain['availability']);
        $this->assertStringContainsString('--neighbors', $licensedExplain['usage']);
        $this->assertSame('Architecture', $licensedExplain['category']);
        $this->assertSame('explain', $licensedExplain['command_type']);
        $this->assertTrue($licensedExplain['supports_pipeline_stage_filter']);
        $this->assertSame('generate <prompt>', $licensedGenerate['signature']);
        $this->assertStringContainsString('--deterministic', $licensedGenerate['usage']);
        $this->assertStringContainsString('--provider=<name>', $licensedGenerate['usage']);
        $this->assertSame('App Scaffolding', $licensedGenerate['category']);
