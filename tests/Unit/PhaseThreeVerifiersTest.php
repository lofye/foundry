...
final class PhaseThreeVerifiersTest extends TestCase
{
...
YAML);
    ...
    public function test_phase_three_verifiers_pass_for_valid_configuration(): void
    {
    ...
    public function test_phase_three_verifiers_report_missing_named_nodes(): void
    {
        $paths = Paths::fromCwd($this->project->root);
        $compiler = new GraphCompiler($paths);
    ...
    public function test_phase_three_verifiers_report_invalid_payloads(): void
    {
        file_put_contents($this->project->root . '/app/specs/billing/stripe.billing.yaml', <<<'YAML'
version: 1
provider: stripe
