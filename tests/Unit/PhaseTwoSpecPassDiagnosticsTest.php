...
final class PhaseTwoSpecPassDiagnosticsTest extends TestCase
{
...
YAML);
    ...
    public function test_phase_two_spec_pass_emits_expected_diagnostics_for_invalid_specs(): void
    {
