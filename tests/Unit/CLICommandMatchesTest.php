...
final class CLICommandMatchesTest extends TestCase
{
    public function test_matches_methods_cover_all_commands(): void
    {
        ...
        $this->assertTrue((new GeneratePhaseTwoCommand())->matches(['generate', 'notification', 'welcome_email']));
        $this->assertTrue((new GeneratePhaseTwoCommand())->matches(['generate', 'api-resource', 'posts', '--spec=specs/posts.api-resource.yaml']));
        $this->assertTrue((new GeneratePhaseTwoCommand())->matches(['generate', 'docs', '--format=markdown']));
        ...
        $this->assertTrue((new VerifyPhaseTwoCommand())->matches(['verify', 'notifications']));
        $this->assertTrue((new VerifyPhaseTwoCommand())->matches(['verify', 'api']));
