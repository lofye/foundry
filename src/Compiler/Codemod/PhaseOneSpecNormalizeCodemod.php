...
final class PhaseOneSpecNormalizeCodemod implements Codemod
{
    public function id(): string
    {
        return 'phase1-spec-v1-normalize';
    }

    public function description(): string
    {
        return 'Normalize Phase 1 specs by setting version: 1 and canonical key ordering.';
    }
    ...
    public function run(Paths $paths, bool $write = false, ?string $path = null): CodemodResult
    {
        ...
        foreach ($this->specPaths($paths, $path) as $absolute) {
            ...
            try {
                ...
                $diagnostics[] = [
                    'code' => 'FDY2213_PHASE1_SPEC_PARSE_ERROR',
                    'severity' => 'error',
                    'category' => 'migrations',
