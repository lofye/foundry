...
final class ApiSurfaceRegistry
{
    ...
    public function resolveCliSignature(array $args): ?string
    {
        ...
        return match ($first) {
            ...
            'implement' => $second === 'feature' ? 'implement feature' : null,
            'cache' => match ($second) {
    ...
    private function cliCommandCategory(string $signature): string
    {
        return match (true) {
            ...
            in_array($signature, ['init', 'new', 'init app', 'examples:list', 'examples:load', 'preview notification', 'implement feature'], true)
